  ...
  return (
    <aside className="bg-white rounded-lg border border-[#d9e2e7] w-full md:w-[260px] flex flex-col p-6 select-none">
      ...
      <div className="mt-auto">
        <Link href="#" className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm text-[#5f7a85] hover:bg-gray-100 font-normal whitespace-nowrap transition-colors mb-2">
